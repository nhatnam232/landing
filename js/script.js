const commandsData = {
  security: {
    ...
    commands: [
      {
        name: "/security",
        description: "Xem trạng thái cấu hình và các module bảo mật đang hoạt động trên server.",
        permission: "Administrator",
      },
      {
        name: "/toggle",
        description: "Bật hoặc tắt nhanh các module: Anti-Raid, Anti-Nuke, Anti-Spam, Anti-Scam, AutoMod Monitor.",
        permission: "Administrator",
      },
      {
        name: "/setlog",
        description: "Thiết lập kênh gửi thông báo log (xóa/sửa tin nhắn, member join/leave, cảnh báo bảo mật).",
        permission: "Administrator",
      },
    ],
  },
  info: {
    ...
    commands: [
      {
        name: "/setup-info",
        description: "Gửi menu thông tin tương tác về Server, Role, Admin và BLV Bún Chả.",
        permission: "Administrator",
      },
    ],
  },
